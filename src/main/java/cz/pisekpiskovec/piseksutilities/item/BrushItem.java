...
import cz.pisekpiskovec.piseksutilities.procedures.BrushRightBrushingProcedure;
import cz.pisekpiskovec.piseksutilities.itemgroup.PUiiToolsItemGroup;
import cz.pisekpiskovec.piseksutilities.gui.BushGUIGuiWindow;
import cz.pisekpiskovec.piseksutilities.gui.BushGUIGui;
import cz.pisekpiskovec.piseksutilities.PiseksUtilitiesIiModElements;

@PiseksUtilitiesIiModElements.ModElement.Tag
public class BrushItem extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:brush")
	public static final Item block = null;

	public BrushItem(PiseksUtilitiesIiModElements instance) {
		super(instance, 273);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BushGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(PUiiToolsItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Brush");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BushGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			return BrushRightBrushingProcedure.executeProcedure(Stream
