...
public class RoastedSeedsItem extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:roasted_seeds")
	public static final Item block = null;

	public RoastedSeedsItem(PiseksUtilitiesIiModElements instance) {
		super(instance, 173);
	}
