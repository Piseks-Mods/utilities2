...
import cz.pisekpiskovec.piseksutilities.gui.PocketAnvilGUIGuiWindow;
import cz.pisekpiskovec.piseksutilities.gui.PocketAnvilGUIGui;
import cz.pisekpiskovec.piseksutilities.PiseksUtilitiesIiModElements;

@PiseksUtilitiesIiModElements.ModElement.Tag
public class PocketAnvilItem extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:pocket_anvil")
	public static final Item block = null;

	public PocketAnvilItem(PiseksUtilitiesIiModElements instance) {
		super(instance, 264);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PocketAnvilGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Pocket Anvil");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PocketAnvilGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
