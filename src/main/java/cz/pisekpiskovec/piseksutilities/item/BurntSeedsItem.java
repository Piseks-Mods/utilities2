...
public class BurntSeedsItem extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:burnt_seeds")
	public static final Item block = null;

	public BurntSeedsItem(PiseksUtilitiesIiModElements instance) {
		super(instance, 177);
	}
