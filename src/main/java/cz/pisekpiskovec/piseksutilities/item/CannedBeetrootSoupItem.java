...
public class CannedBeetrootSoupItem extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:canned_beetroot_soup")
	public static final Item block = null;

	public CannedBeetrootSoupItem(PiseksUtilitiesIiModElements instance) {
		super(instance, 165);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(PUiiFoodItemGroup.tab).maxStackSize(16).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(6).saturation(7.2f)
							...
							.build()));
			setRegistryName("canned_beetroot_soup");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Beetroot Soup"));
		}
