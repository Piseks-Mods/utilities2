...
public class CheeseItem extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:cheese")
	public static final Item block = null;

	public CheeseItem(PiseksUtilitiesIiModElements instance) {
		super(instance, 207);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(PUiiFoodItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(1).saturation(0.6f).setAlwaysEdible().build()));
