...
public class SaladItem extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:salad")
	public static final Item block = null;

	public SaladItem(PiseksUtilitiesIiModElements instance) {
		super(instance, 198);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(PUiiFoodItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(8).saturation(3.6f)

							.build()));
			setRegistryName("salad");
		}
