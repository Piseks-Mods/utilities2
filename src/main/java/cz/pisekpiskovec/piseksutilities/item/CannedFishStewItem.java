...
public class CannedFishStewItem extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:canned_fish_stew")
	public static final Item block = null;

	public CannedFishStewItem(PiseksUtilitiesIiModElements instance) {
		super(instance, 195);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(PUiiFoodItemGroup.tab).maxStackSize(16).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(6).saturation(7.2f)
							...
							.build()));
			setRegistryName("canned_fish_stew");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Fish Stew"));
		}
