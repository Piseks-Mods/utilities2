...
public class ApplePieItem extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:apple_pie")
	public static final Item block = null;

	public ApplePieItem(PiseksUtilitiesIiModElements instance) {
		super(instance, 191);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(PUiiFoodItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(8).saturation(4.8f)
