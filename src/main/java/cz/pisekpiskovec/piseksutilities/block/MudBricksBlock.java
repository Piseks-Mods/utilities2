...
public class MudBricksBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:mud_bricks")
	public static final Block block = null;

	public MudBricksBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 23);
	}
