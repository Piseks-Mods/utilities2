...
public class DarkenedGlassBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:darkened_glass")
	public static final Block block = null;

	public DarkenedGlassBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 287);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkened_glass");
		}
