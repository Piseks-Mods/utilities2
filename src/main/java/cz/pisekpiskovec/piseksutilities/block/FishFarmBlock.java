...
import cz.pisekpiskovec.piseksutilities.procedures.FishFarmTickProcedure;
...
public class FishFarmBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:fish_farm")
	public static final Block block = null;
	@ObjectHolder("piseks_utilities_ii:fish_farm")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public FishFarmBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 81);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("fish_farm"));
		}
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			FishFarmTickProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("fish_farm");
		}
