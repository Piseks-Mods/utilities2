...
public class MagmaCreamBlockBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:magma_cream_block")
	public static final Block block = null;

	public MagmaCreamBlockBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 260);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			MagmaCreamBurnProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
