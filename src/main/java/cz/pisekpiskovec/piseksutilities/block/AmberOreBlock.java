...
public class AmberOreBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:amber_ore")
	public static final Block block = null;

	public AmberOreBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 249);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("piseks_utilities_ii:amber_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("amber_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("piseks_utilities_ii:amber_ore"), configuredFeature);
		}
	}
