...
public class AmberStairsBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:amber_stairs")
	public static final Block block = null;

	public AmberStairsBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 251);
	}
