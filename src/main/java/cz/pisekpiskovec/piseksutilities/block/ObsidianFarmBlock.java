...
import cz.pisekpiskovec.piseksutilities.procedures.ObsidianFarmTickProcedure;
...
public class ObsidianFarmBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:obsidian_farm")
	public static final Block block = null;
	@ObjectHolder("piseks_utilities_ii:obsidian_farm")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public ObsidianFarmBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 100);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("obsidian_farm"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			world.getPendingBlockTicks().scheduleTick(pos, this, 2820);
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			ObsidianFarmTickProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("obsidian_farm");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Obsidian Farm");
		}
