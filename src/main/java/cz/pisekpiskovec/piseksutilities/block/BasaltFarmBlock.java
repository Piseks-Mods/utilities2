...
import cz.pisekpiskovec.piseksutilities.procedures.BasaltFarmTickProcedure;
...
public class BasaltFarmBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:basalt_farm")
	public static final Block block = null;
	@ObjectHolder("piseks_utilities_ii:basalt_farm")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public BasaltFarmBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 112);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("basalt_farm"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			BasaltFarmTickProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("basalt_farm");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Basalt Farm");
		}
