...
import cz.pisekpiskovec.piseksutilities.procedures.ChorusFarmTickProcedure;
...
public class ChorusFarmBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:chorus_farm")
	public static final Block block = null;
	@ObjectHolder("piseks_utilities_ii:chorus_farm")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public ChorusFarmBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 84);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("chorus_farm"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			ChorusFarmTickProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("chorus_farm");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Chorus Farm");
		}
