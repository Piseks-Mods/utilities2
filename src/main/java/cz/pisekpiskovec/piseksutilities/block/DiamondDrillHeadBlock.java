...
public class DiamondDrillHeadBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:diamond_drill_head")
	public static final Block block = null;
	@ObjectHolder("piseks_utilities_ii:diamond_drill_head")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public DiamondDrillHeadBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 64);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("diamond_drill_head"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			DiamondDrillHeadBreakProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("diamond_drill_head");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Diamond Drill Head");
		}
