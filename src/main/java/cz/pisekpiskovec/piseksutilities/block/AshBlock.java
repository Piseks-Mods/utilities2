...
import cz.pisekpiskovec.piseksutilities.procedures.AshRedstoneProcedure;
import cz.pisekpiskovec.piseksutilities.procedures.AshBlowProcedure;
import cz.pisekpiskovec.piseksutilities.PiseksUtilitiesIiModElements;

@PiseksUtilitiesIiModElements.ModElement.Tag
public class AshBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:ash")
	public static final Block block = null;

	public AshBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.SAND).sound(SoundType.SAND).hardnessAndResistance(0.5f, 0.5f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.SHOVEL).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("ash");
		}
		...
		public int getWeakPower(BlockState blockstate, IBlockReader blockAccess, BlockPos pos, Direction direction) {
			...
			return (int) AshRedstoneProcedure.executeProcedure(Stream
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			AshBlowProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
