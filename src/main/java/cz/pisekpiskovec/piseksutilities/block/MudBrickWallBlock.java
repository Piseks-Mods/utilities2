...
public class MudBrickWallBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:mud_brick_wall")
	public static final Block block = null;

	public MudBrickWallBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mud_brick_wall");
		}
