...
import cz.pisekpiskovec.piseksutilities.procedures.EggFarmTickProcedure;
...
public class EggFarmBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:egg_farm")
	public static final Block block = null;
	@ObjectHolder("piseks_utilities_ii:egg_farm")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public EggFarmBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 77);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("egg_farm"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7eWill be edited"));
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			world.getPendingBlockTicks().scheduleTick(pos, this, 9000);
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			EggFarmTickProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("egg_farm");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Egg Farm");
		}
