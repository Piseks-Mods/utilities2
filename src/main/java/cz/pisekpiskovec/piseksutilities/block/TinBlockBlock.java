...
public class TinBlockBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:tin_block")
	public static final Block block = null;

	public TinBlockBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 161);
	}
