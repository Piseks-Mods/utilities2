...
import cz.pisekpiskovec.piseksutilities.procedures.CowOfEternityMilkingProcedure;
...
public class CowOfEternityBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:cow_of_eternity")
	public static final Block block = null;

	public CowOfEternityBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 325);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			CowOfEternityMilkingProcedure.executeProcedure(Stream
