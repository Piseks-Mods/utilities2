...
public class RopeBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:rope")
	public static final Block block = null;

	public RopeBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 223);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOL).sound(SoundType.CLOTH).hardnessAndResistance(1f, 1f).setLightLevel(s -> 0).notSolid()
