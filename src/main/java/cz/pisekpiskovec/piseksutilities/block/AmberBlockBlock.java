...
public class AmberBlockBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:amber_block")
	public static final Block block = null;

	public AmberBlockBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 248);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AmberItem.block, (int) (4)));
		}
	}
}
