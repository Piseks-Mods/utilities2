...
public class PaperWallPaneBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:paper_wall_pane")
	public static final Block block = null;

	public PaperWallPaneBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 219);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.LADDER).hardnessAndResistance(0.1f, 0.1f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).doesNotBlockMovement());
			setRegistryName("paper_wall_pane");
		}
