...
import cz.pisekpiskovec.piseksutilities.procedures.CobblestoneFarmTickProcedure;
...
public class CobblestoneFarmBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:cobblestone_farm")
	public static final Block block = null;
	@ObjectHolder("piseks_utilities_ii:cobblestone_farm")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public CobblestoneFarmBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 74);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("cobblestone_farm"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("cobblestone_farm");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			CobblestoneFarmTickProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("cobblestone_farm");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Cobblestone Farm");
		}
