...
public class MachineGridBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:machine_grid")
	public static final Block block = null;

	public MachineGridBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 43);
	}
