...
import cz.pisekpiskovec.piseksutilities.procedures.LightningRodGenerateProcedure;
...
public class LightningRodT1Block extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:lightning_rod_t1")
	public static final Block block = null;

	public LightningRodT1Block(PiseksUtilitiesIiModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 17, 16))
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			LightningRodGenerateProcedure.executeProcedure(Stream
