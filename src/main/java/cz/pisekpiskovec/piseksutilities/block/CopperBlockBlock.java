...
public class CopperBlockBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:copper_block")
	public static final Block block = null;

	public CopperBlockBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 146);
	}
