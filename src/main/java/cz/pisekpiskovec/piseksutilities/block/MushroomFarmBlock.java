...
import cz.pisekpiskovec.piseksutilities.procedures.MushroomFarmTickProcedure;
...
public class MushroomFarmBlock extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:mushroom_farm")
	public static final Block block = null;
	@ObjectHolder("piseks_utilities_ii:mushroom_farm")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public MushroomFarmBlock(PiseksUtilitiesIiModElements instance) {
		super(instance, 92);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("mushroom_farm"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			MushroomFarmTickProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("mushroom_farm");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Mushroom Farm");
		}
