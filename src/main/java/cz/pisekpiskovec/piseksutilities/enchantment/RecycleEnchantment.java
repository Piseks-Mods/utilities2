...
public class RecycleEnchantment extends PiseksUtilitiesIiModElements.ModElement {
	@ObjectHolder("piseks_utilities_ii:recycle")
	public static final Enchantment enchantment = null;

	public RecycleEnchantment(PiseksUtilitiesIiModElements instance) {
		super(instance, 1);
	}

	@Override
	public void initElements() {
		elements.enchantments.add(() -> new CustomEnchantment(EquipmentSlotType.MAINHAND).setRegistryName("recycle"));
	}
