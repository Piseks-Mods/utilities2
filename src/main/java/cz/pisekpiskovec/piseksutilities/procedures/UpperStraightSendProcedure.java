...
public class UpperStraightSendProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		double slotIDRemote = 0;
		double slotIDLocal = 0;
		if (new Object() {
			...
			for (int index0 = 0; index0 < (int) (5); index0++) {
				if (new Object() {
				...
				}.getAmount(world, new BlockPos(x, y, z), (int) (slotIDLocal)) > 0) {
					for (int index1 = 0; index1 < (int) (new Object() {
						...
						if ((new Object() {
						...
						}.getItemStack(new BlockPos(x, y, z), (int) (slotIDLocal))).getItem() == (new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
						...
						}.getItemStack(new BlockPos(x, y + 1, z), (int) (slotIDRemote))).getItem() && new Object() {
							public int getAmount(IWorld world, BlockPos pos, int sltid) {
								AtomicInteger _retval = new AtomicInteger(0);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
						...
						}.getAmount(world, new BlockPos(x, y + 1, z), (int) (slotIDRemote)) < 64 || new Object() {
							public int getAmount(IWorld world, BlockPos pos, int sltid) {
								AtomicInteger _retval = new AtomicInteger(0);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
						...
						}.getAmount(world, new BlockPos(x, y + 1, z), (int) (slotIDRemote)) == 0) {
							{
								TileEntity _ent = world.getTileEntity(new BlockPos(x, y + 1, z));
								if (_ent != null) {
									final int _sltid = (int) (slotIDRemote);
									...
									}.getItemStack(new BlockPos(x, y + 1, z), (int) (slotIDRemote)));
									...
									}.getAmount(world, new BlockPos(x, y + 1, z), (int) (slotIDRemote)) + 1));
									_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
							...
							slotIDRemote = (slotIDRemote + 1);
						}
					}
					break;
				} else {
					slotIDLocal = (slotIDLocal + 1);
				}
			}
		}
	}
