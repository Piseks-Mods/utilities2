...
public class UpperBendSendProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				PiseksUtilitiesIiMod.LOGGER.warn("Failed to load dependency world for procedure UpperBendSend!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				PiseksUtilitiesIiMod.LOGGER.warn("Failed to load dependency x for procedure UpperBendSend!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				PiseksUtilitiesIiMod.LOGGER.warn("Failed to load dependency y for procedure UpperBendSend!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				PiseksUtilitiesIiMod.LOGGER.warn("Failed to load dependency z for procedure UpperBendSend!");
			return;
		}
		if (dependencies.get("blockstate") == null) {
			if (!dependencies.containsKey("blockstate"))
				PiseksUtilitiesIiMod.LOGGER.warn("Failed to load dependency blockstate for procedure UpperBendSend!");
			return;
		}
		...
		for (int index0 = 0; index0 < (int) (5); index0++) {
			for (int index1 = 0; index1 < (int) (new Object() {
			...
			}.getAmount(world, new BlockPos((x + xMod), y, (z + zMod)))); index1++) {
				if (new Object() {
				...
				}.getAmount(world, new BlockPos(x, y, z), (int) (remoteID)) == 64) {
					remoteID = (remoteID + 1);
				}
			}
			if (new Object() {
			...
			}.getAmount(world, new BlockPos(x + xMod, y, z + zMod), (int) (remoteID)) == 0) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos(x + xMod, y, z + zMod));
					if (_ent != null) {
			...
			}.getItemStack(new BlockPos(x + xMod, y, z + zMod), (int) (remoteID))).getItem() && new Object() {
				public int getAmount(IWorld world, BlockPos pos, int sltid) {
					AtomicInteger _retval = new AtomicInteger(0);
					TileEntity _ent = world.getTileEntity(pos);
					if (_ent != null) {
			...
			}.getAmount(world, new BlockPos(x + xMod, y, z + zMod), (int) (remoteID)) < 64) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos(x + xMod, y, z + zMod));
					if (_ent != null) {
						final int _sltid = (int) (remoteID);
						...
						}.getAmount(world, new BlockPos(x + xMod, y, z + zMod), (int) (remoteID)) + 1));
						_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
							if (capability instanceof IItemHandlerModifiable) {
								((IItemHandlerModifiable) capability).setStackInSlot(_sltid, _setstack);
							}
