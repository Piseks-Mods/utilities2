...
public class IronDrillHeadBreakProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((world instanceof World) ? ((World) world).isBlockPowered(new BlockPos(x, y, z)) : false) && !world.isAirBlock(new BlockPos(x, y + 1, z))
				&& (Items.IRON_SWORD.canHarvestBlock((world.getBlockState(new BlockPos(x, y + 1, z))))
						|| Items.IRON_SHOVEL.canHarvestBlock((world.getBlockState(new BlockPos(x, y + 1, z))))
						|| Items.IRON_PICKAXE.canHarvestBlock((world.getBlockState(new BlockPos(x, y + 1, z))))
						|| Items.IRON_AXE.canHarvestBlock((world.getBlockState(new BlockPos(x, y + 1, z))))
						|| Items.IRON_HOE.canHarvestBlock((world.getBlockState(new BlockPos(x, y + 1, z)))))) {
